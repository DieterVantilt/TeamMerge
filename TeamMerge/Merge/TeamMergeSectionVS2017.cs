...
namespace TeamMerge.Merge
{
        ...
        : TeamExplorerSectionBase
    {
        ...
        protected override ITeamExplorerSection CreateViewModel(SectionInitializeEventArgs e)
        {
            ...
            var versionControlService = new VersionControlServiceVS2017(ServiceProvider);
            ...
            var teamExplorerService = new TeamExplorerServiceVS2017(ServiceProvider, tfvcService);
            ...
            return base.CreateViewModel(e) ?? new TeamMergeViewModel2017(teamService, mergeOperation, configHelper, logger, solutionService);
        }
